...
<?php
class purchaseorders_status_Model extends model
{
	...
	function load(){
		...
		echo "  <ul class='data_list' id='ul_".$value['id']."'>
				...
				<li></li>";
		if($value['status']=='1'){
		echo "	<li> <span class='label label-success'>Order Confirmed</span></li>";
		}else{
		echo "	<li><span class='label label-warning'>Pending</span></li>";
		}
