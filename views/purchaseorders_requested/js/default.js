...
var url=root_url+'purchaseorders_requested/load/';
...
var root_url=$("#root_url").val();
var url=root_url+'purchaseorders_requested/delete_sub/';
$.ajax({
type:'post',
url:url,
data:{id:val[1]},
...
var root_url=$("#root_url").val();
var url=root_url+'purchaseorders_requested/edit_sub/';
...
$('.pagin').on('click','.add_new',function(){
  ...
  var val=$('#new_count').val();
    var root_url=$("#root_url").val();
    var url=root_url+"purchaseorders_requested/create_new";
  $.ajax({
    type:'post',
    cache:'false',
...
$('.pagin').on('change','.addnew_stockitems',function(){
    ...
    var val=$(this).val();
    var root_url=$("#root_url").val();
    var url=root_url+"purchaseorders_requested/load_item";
  $.ajax({
    type:'post',
    url:url,
    data:{id:val},
...
$('.pagin').on('click','.new_save',function(){
  ...
  var val_8=$("#val8_"+index).val();
    ...
    var root_url=$("#root_url").val();
    var url=root_url+"purchaseorders_requested/save_new";
  $.ajax({
    type:'post',
    url:url,
...
var invoiceno=aa[1];
    var root_url=$("#root_url").val();
    var url=root_url+"purchaseorders_requested/deleteorder";
  $.ajax({
    type:'post',
    url:url,
    data:{id:invoiceno},
...
var invoiceno=aa[1];
    var root_url=$("#root_url").val();
    var url=root_url+"purchaseorders_requested/confirmorder";
  $.ajax({
    type:'post',
    url:url,
    data:{id:invoiceno},
