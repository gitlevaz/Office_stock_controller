...
<div class="col-sm-2 col-md-2">
	...
	<?php
	include 'views/common/purchaseordersreq_left.php';
	?>	
</div>
	  ...
	  <div class="row datalist">
		  <div class="col-md-12 col-sm-12">
			  <div class="panel panel-default">
			    ...
			    <h1><i class="fa fa-newspaper-o" aria-hidden="true" style="margin-right:0.5%; transform: rotate(90deg);"></i> Requested Purchase Orders</h1>
			  </div>
			  <div class="row">
