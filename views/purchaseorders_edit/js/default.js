...
var url=root_url+'purchaseorders_edit/load/';
...
var root_url=$("#root_url").val();
var url=root_url+'purchaseorders_edit/delete_sub/';
$.ajax({
type:'post',
url:url,
data:{id:val[1]},
...
var root_url=$("#root_url").val();
var url=root_url+'purchaseorders_edit/edit_sub/';
...
$('.pagin').on('click','.add_new',function(){
  ...
  var val=$('#new_count').val();
    var root_url=$("#root_url").val();
    var url=root_url+"purchaseorders_edit/create_new";
  $.ajax({
    type:'post',
    cache:'false',
...
$('.pagin').on('change','.addnew_stockitems',function(){
    ...
    var val=$(this).val();
    var root_url=$("#root_url").val();
    var url=root_url+"purchaseorders_edit/load_item";
  $.ajax({
    type:'post',
    url:url,
    data:{id:val},
...
$('.pagin').on('click','.new_save',function(){
  ...
  var val_8=$("#val8_"+index).val();
    ...
    var root_url=$("#root_url").val();
    var url=root_url+"purchaseorders_edit/save_new";
  $.ajax({
    type:'post',
    url:url,
...
var invoiceno=aa[1];
    var root_url=$("#root_url").val();
    var url=root_url+"purchaseorders_edit/deleteorder";
  $.ajax({
    type:'post',
    url:url,
    data:{id:invoiceno},
