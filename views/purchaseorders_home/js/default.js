...
form.subscribe('parsley:form:success', function (e) {
	var data=$('.form_main').serialize();
			...
			var url=root_url+"purchaseorders_home/save_main";
	$.ajax({
	type:'post',
	url:url,
	data:data,
	...
	success:function(data){
		    if(data.reply=="10"){
		    	invoice_id=data.id;
				var root_url=$("#root_url").val();
				var url=root_url+"purchaseorders_home/save_sub";
				var jsonObj = {};
				  ...
				  success:function(data){
				     if(data.reply=="10"){
				      ...
				      if(invoice_id != null || invoice_id !=''){
				      	var urlsub=root_url+"purchaseorders_home/remove_invoice";
				      	$.ajax({
				      		type:'post',
				      		url:urlsub,
				      		data:{id:invoice_id},
