...
<a class="close rega_cancel" href="/">Close</a>
<div class="row">
    <div id="login_form">
        <br>
...
<div class="col-sm-2 col-md-2">
    ...
    <div class="row">
    	<div class="col-sm-12 col-md-12">
    	    <h4 style="margin-top:0;color:#b59595;">Recent Invoices</h4>
...
<div class="col-sm-10 col-md-10">
	<div class="panel panel-info">
	  <div class="panel-heading"><h1><i class="fa fa-newspaper-o" aria-hidden="true" style="margin-right:0.5%; transform: rotate(90deg);"></i>Edit Invoice</h1></div>
	  <div class="panel-body">
	<form action="" id="" class="form_main" data-parsley-validate=""> 
	 <input type="hidden" name="localtime" id="localtime">
	 <div class="row">
		 	<div class="col-sm-3 col-md-3">
				 <input type="text" class="form-control pres_no" name="val_1" placeholder="Invoice Number" disabled>
				 <input type="text" class="form-control patient_number" name="val_2" placeholder="Client Number" tabindex="1" disabled>
				 <a href="" class="pt_history">View Client History</a>
		 	</div>
		 	<div class="col-sm-3 col-md-3">
				 <input type="text" class="form-control pres_date" name="val_3" placeholder="date" required="" id="demo" disabled>
				 <select id="customerselect" data-options="customer customers first_name id Select_Patient first_name"  class="customer form-control getdata_options"  name="val_4" required="" disabled>
				 </select>
		 	</div>
		 	<div class="col-sm-3 col-md-3">
		 	...
		 	<div class="col-sm-3 col-md-3">
		 	     <textarea  class="form-control pres_note" rows="3" placeholder="note" name="val_7" disabled></textarea>
		 	</div>
	 </div>
	</form>
	</div>
