...
<div class="col-sm-2 col-md-2">
	...
	<?php
	include 'views/common/substoreisn_right.php';
	?>	
</div>
<div class="col-sm-10 col-md-10">
	<div class="panel panel-info">
	  <div class="panel-heading"><h1><i class="fa fa-sticky-note" aria-hidden="true" style="margin-right:0.5%"></i>Add Issue note</h1></div>
	  <div class="panel-body">
	<form action="" id="" class="form_main" data-parsley-validate=""> 
	 <div class="row">
		 	<div class="col-sm-6 col-md-6">
				 <input type="text" class="form-control index issuenotemaster" name="val_1" placeholder="Isn Number" disabled="">
				 <select id="supplierr" data-options="substores substore branch_name id"  class="substores form-control getdata_options" name="val_2" required="">
				 </select>
		 	</div>
		 	<div class="col-sm-6 col-md-6">
  ...
  <div class="panel-body">
	...
	<!-- <input type="text" readonly="" id="total_val" class="number_format" value="0.00"> -->
		<div class="row">
	  	...
	  	<div class="col-sm-6 col-md-6">
		<button type="button" class="btn btn-primary btn-block" id="save_btn">Save Issue Note</button>
		<div id="msg_box"></div>
		</div>
	    </div>
  </div>
