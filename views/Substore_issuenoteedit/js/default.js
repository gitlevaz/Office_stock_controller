...
var url=root_url+'Substore_issuenoteedit/load/';
...
$(".pagin").on('keyup','.unitprice',function(){
  id=$(this).data("id");
  iisnno=$(this).data("id-bb");
  cal_amount(id,isnno);
});

//delete subitems
$('.pagin').on('click','.btn_subdelete',function(){
var isnno=$(this).data("id-bb");
var val1=$(this).attr('id');
var val=val1.split("_");
var root_url=$("#root_url").val();
var url=root_url+'Substore_issuenoteedit/delete_sub/';
$.ajax({
type:'post',
url:url,
data:{id:val[1]},
...
var root_url=$("#root_url").val();
var url=root_url+'Substore_issuenoteedit/edit_sub/';

$.ajax({
type:'post',
url:url,
data:{val_1:idd,val_2:isnno,val_3:item_code,val_4:item_name,val_5:unitprice,val_6:quantity,val_7:unit,val_10:total},
dataType:'json',
success:function(data){
  if(data.reply=='10'){
    alert('done');
...
$('.pagin').on('change','#stockitems',function(){
    ...
    var val=$(this).val();
    var root_url=$("#root_url").val();
    var url=root_url+"Substore_issuenoteedit/load_item";
  $.ajax({
    type:'post',
    url:url,
    data:{id:val},
...
$('.pagin').on('click','.add_new',function(){
  ...
  var val=$('#new_count').val();
    var root_url=$("#root_url").val();
    var url=root_url+"Substore_issuenoteedit/create_new";
  $.ajax({
    type:'post',
    cache:'false',
    data:{count:val,isnno:id},
    url: url,
    dataType:'html',
    success:function(data){
...
$('.pagin').on('click','.new_save',function(){
  ...
  var val_8=$("#val8_"+index).val();
    ...
    var root_url=$("#root_url").val();
    var url=root_url+"Substore_issuenoteedit/save_new";
  $.ajax({
    type:'post',
    url:url,
    data:{isnid:isnno,val1:val_1,val2:val_2,val3:val_3,val4:val_4,val5:val_5,val8:val_8},
    dataType:'html',
    beforeSend:function(data){

    },
    success:function(data){
        $('.body_'+isnno).prepend(data);
        $('.'+index).remove();
        sub_total(isnno);
    }
  });
...
var isnno=aa[1];
    var root_url=$("#root_url").val();
    var url=root_url+"Substore_issuenoteedit/deleteissue";
  $.ajax({
    type:'post',
    url:url,
    data:{id:isnno},
