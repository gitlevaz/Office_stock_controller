...
var url=$(this).attr('action');
	$.ajax({
	    ...
	    success:function(data){
	     if(data.reply=="10"){
	      $("#msg_box").html('');  
	      $("#msg_box").append("<div class='alert alert-success'>Supplier Updated.</div>");
...
var root_url=$("#root_url").val();
var url=root_url+"Supplier_edit/load_pages";
...
var root_url=$("#root_url").val();
var url=root_url+"Supplier_edit/edit_load";
var id=$(this).attr('id');
	$.ajax({
		type:'post',
		url: url,
...
//end of edit function
		...
		var root_url=$("#root_url").val();
		var url=root_url+"Supplier_edit/delete";
		var id=$(this).attr('id');
		confirm_function();
...
//     $.ajax({
// 		url: root_url+"Supplier_edit/delete/"+seller_id,
//       type: 'POST'
//     })
//     .done(function(data){
// 		$("#msg_box").html('');  
