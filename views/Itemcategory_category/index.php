...
<div class="col-sm-10 col-md-10">
	<div class="panel panel-info">
	  <div class="panel-heading"><h1><i class="fa fa-medkit" aria-hidden="true" style="margin-right:0.5%"></i>Add Item Category</h1></div>
	  <div class="panel-body">
	<form action="<?php echo ROOT?>Itemcategory_category/create" id="" class="category_form" data-parsley-validate=""> 
