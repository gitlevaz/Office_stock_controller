...
<div class="col-sm-2 col-md-2">
	...
	<?php
	include 'views/common/substorereturn_right.php';
	?>	
</div>
<div class="col-sm-10 col-md-10">
	<div class="panel panel-info">
	  <div class="panel-heading"><h1><i class="fa fa-reply" aria-hidden="true" style="margin-right:0.5%"></i>Add Return note</h1></div>
	  <div class="panel-body">
	<form action="" id="" class="form_main" data-parsley-validate=""> 
	 <div class="row">
		 	<div class="col-sm-6 col-md-6">
				 <input type="text" class="form-control index substorreturnmaster" name="val_1" placeholder="rtnno Number" disabled="">
				 <select id="substores_data" data-options="substores substore branch_name id"  class="substores form-control getdata_options" name="val_2" required="">
				 </select>
		 	</div>
		 	<div class="col-sm-6 col-md-6">
				 <input type="text" class="form-control datepicker" name="val_3" placeholder="date" required="">
				 <select id="issuenotemasters_data" class="issuenote form-control" name="val_4" required="">
				 </select>
		 	</div>
	 </div>
	</form>
