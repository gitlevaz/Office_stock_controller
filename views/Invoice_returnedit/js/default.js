...
var url=root_url+'Invoice_returnedit/load/';
...
$(function($) {
          ...
          $('.pagin').on('click','.btn_edit2',function() {
            ...
            {
              $(this).html('Show / Edit Invoice');
              $(this).removeClass('open');
              $(this).next().slideUp("slow");
            }
            else
            {
            $(this).html('Hide / Edit Invoice');
...
var root_url=$("#root_url").val();
var url=root_url+'Invoice_returnedit/delete_sub/';
$.ajax({
type:'post',
url:url,
data:{id:val[1]},
...
var root_url=$("#root_url").val();
var url=root_url+'Invoice_returnedit/edit_sub/';
...
type:'post',
url:url,
data:{val_1:idd,val_2:rtnno,val_3:item_code,val_4:item_name,val_5:unitprice,val_6:quantity,val_7:unit,val_10:total,val_11:qty_diff,val_12:qty_diffcat,val_13:actitem,val_14:actqty},
dataType:'json',
success:function(data){
...
$('.pagin').on('change','#stockitems',function(){
    ...
    var val=$(this).val();
    var root_url=$("#root_url").val();
    var url=root_url+"Invoice_returnedit/load_item";
  $.ajax({
    type:'post',
    url:url,
    data:{id:val},
...
$('.pagin').on('click','.add_new',function(){
  ...
  var invno=$(this).data("id-isnno");
    var root_url=$("#root_url").val();
    var url=root_url+"Invoice_returnedit/create_new";
  $.ajax({
    type:'post',
    cache:'false',
    data:{count:val,rtnno:id,inv_no:invno},
    url: url,
    dataType:'html',
    success:function(data){
...
$('.pagin').on('click','.new_save',function(){
  ...
  var val_8=$("#val8_"+index).val();
    ...
    var root_url=$("#root_url").val();
    var url=root_url+"Invoice_returnedit/save_new";
  $.ajax({
    type:'post',
    url:url,
    data:{rtnid:rtnno,inv_no:invno,val1:val_1,val2:val_2,val3:val_3,val4:val_4,val5:val_5,val8:val_8},
    dataType:'html',
...
var rtnno=aa[1];
    var root_url=$("#root_url").val();
    var url=root_url+"Invoice_returnedit/deletereturn";
  $.ajax({
    type:'post',
    url:url,
    data:{id:rtnno},
